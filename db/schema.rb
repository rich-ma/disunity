...
ActiveRecord::Schema.define(version: 2018_09_25_011004) do
  ...
  create_table "servers_memberships", force: :cascade do |t|
    t.integer "server_id", null: false
    t.integer "user_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["server_id", "user_id"], name: "index_servers_memberships_on_server_id_and_user_id", unique: true
  end
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.index ["username", "username_salt"], name: "index_users_on_username_and_username_salt", unique: true
